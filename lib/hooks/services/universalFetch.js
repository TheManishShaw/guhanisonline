...
export const getAllTestimonialList = async () => {
  try {
    const res = await axiosInstance.get(`/testimonials`).then((res) => res);
...
export const getTestimonialById = async (testimonial_id) => {
  try {
...
export const addTestimonial = async (formData) => {
  try {
    ...
    const result = await axiosInstance.post(`/testimonials`, apiData);
    return result.data;
  } catch (error) {
    console.log("error=====>", error);
    throw error;
...
export const updateTestimonialById = async (testimonial_id, formData) => {
  try {
    // Transform frontend data to match API expectations
    const apiData = {
      ...formData,
    ...
    const response = await axiosInstance
      .put(`/testimonials/${testimonial_id}`, apiData)
      .then((res) => res.data);
    return response;
  } catch (error) {
    console.log("error=====>", error);
...
export const deleteTestimonialById = async (testimonial_id) => {
  try {
    const response = await axiosInstance

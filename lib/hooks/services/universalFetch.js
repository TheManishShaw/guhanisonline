...
export const addBlog = async (formData) => {
  try {
    const result = await axiosInstance.post(`/blog/add`, formData);
...
export const getAllTestimonialList = async () => {
  try {
    const res = await axiosInstance.get(`/testimonials/list`).then((res) => res);
    return res.data;
  } catch (error) {
    toast.error(`Something Went Wrong! ${error}`);
  }
...
export const getOpenTestimonialList = () => {
  try {
    const response = axiosInstance
      .post(`/openapi/testimonials/list`)
      .then((res) => res.data);
    return response;
  } catch (error) {
    console.log("error=====>", error);
...
export const getTestimonialById = (testimonial_id) => {
  try {
    const response = axiosInstance
      .get(`/testimonials/details/${testimonial_id}`)
      .then((res) => res.data);
    return response;
  } catch (error) {
    console.log("error=====>", error);
...
export const updateTestimonialById = (testimonial_id, formData) => {
  try {
    const response = axiosInstance
      .put(`/testimonials/update/${testimonial_id}`, formData)
      .then((res) => res);
    return response;
  } catch (error) {
    console.log("error=====>", error);
...
export const deleteTestimonialById = (testimonial_id) => {
  try {
    const response = axiosInstance
      .delete(`/testimonials/delete/${testimonial_id}`)
      .then((res) => res);
    return response;
  } catch (error) {
    console.log("error=====>", error);

...
const PublicBlogDetailPage = () => {
  ...
  return (
    <section className="overflow-hidden container px-8 pt-[40px] pb-[120px]">
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-8/12">
            <div>
              <h2 className="mb-8 text-3xl font-bold leading-tight text-white dark:text-white sm:text-4xl sm:leading-tight">
                {blogDetail?.title}
              </h2>
              <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                <div className="flex flex-wrap items-center">
                  <div className="mr-10 mb-5 flex items-center">
                    ...
                    <div className="w-full">
                      <h4 className="mb-1 text-xl font-medium text-body-color">
                        By{" "}
                  ...
                  <div className="mb-5 flex items-center">
                    <p className="mr-5 flex items-center text-base font-medium text-body-color">
                      ...
                      {moment(blogDetail?.created_at).format("MMMM Do YYYY  ")}
                    </p>
                    {/* <p className="mr-5 flex items-center text-base font-medium text-body-color">
                      <span className="mr-3">
                        <svg
                ...
                {/* <div className="mb-5">
                  <a
                    href="#0"
                    className="inline-flex items-center justify-center rounded-full bg-secondary py-2 px-4 text-sm font-semibold text-white"
                  >
                    new category
                  </a>
                </div> */}
              ...
              <div>
                ...
                {/* <div className="items-center justify-between sm:flex">
                  <div className="mb-5 max-w-4xl">
                    <h5 className="mb-3 text-xl font-medium text-body-color">
                      Popular Tags :
                    </h5>
                    <div className="flex w-96 items-center">
                      {blogDetail?.tags.split(",").map((tag, index) => (
                        <p
                          key={index}
                          className="mr-3 mb-3 capitalize inline-flex items-center justify-center rounded-md bg-primary bg-opacity-10 py-2 px-4 text-body-color duration-300 hover:bg-opacity-100 hover:text-white"
                        >
                          {tag}
                        </p>
                      ))}
            ...
            <div className="mb-10 rounded-md bg-primary bg-opacity-5 dark:bg-opacity-10">
              ...
              <div className="flex flex-wrap py-6 px-8">
                {blogDetail?.tags.split(",").map((tag, index) => (
                  <p
                    key={index}
                    className="mr-3 mb-3 capitalize inline-flex items-center justify-center rounded-md bg-primary bg-opacity-10 py-2 px-4 text-body-color duration-300 hover:bg-opacity-100 hover:text-black"
                  >
                    {tag}
                  </p>
                ))}

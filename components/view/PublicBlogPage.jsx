...
const PublicBlogPage = () => {
  ...
  const ThreadedPost = ({ post, level = 0 }) => (
    <div className={`${level > 0 ? 'ml-8 border-l-2 border-gray-600/30 pl-4' : ''} mb-4`}>
      <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 hover:border-[#5eead4]/30 transition-all duration-300">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-6">
              ...
              <button className="flex items-center gap-2 text-gray-400 hover:text-[#5eead4] text-sm transition-colors">
              ...
              {post.threadsUrl && level === 0 && (
                <a
                  ...
                  className="flex items-center gap-2 text-gray-400 hover:text-[#5eead4] text-sm transition-colors"
                >
  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-400">{blogsList?.data?.length || 0} posts</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 bg-[#5eead4]/10 hover:bg-[#5eead4]/20 border border-[#5eead4]/30 hover:border-[#5eead4]/50 rounded-xl px-4 py-2 text-[#5eead4] transition-all duration-300"
          >
            <MessageCircle className="w-4 h-4" />
            <span>{showThreadedPosts ? 'Hide' : 'Show'} Threads Posts</span>
            {newPostsCount > 0 && (
          ...
          {showThreadedPosts && (
            <button
              ...
              className="flex items-center gap-2 bg-gray-700/50 hover:bg-gray-700/70 border border-gray-600/50 rounded-xl px-3 py-2 text-gray-300 hover:text-white transition-all duration-300 disabled:opacity-50"
            >
      ...
      {showThreadedPosts && (
        <div className="mb-12">
          <div className="bg-gradient-to-r from-[#5eead4]/5 to-transparent border border-[#5eead4]/20 rounded-2xl p-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-gradient-to-br from-[#5eead4] to-cyan-400 rounded-lg flex items-center justify-center">
                  <MessageCircle className="w-4 h-4 text-white" />
                </div>
                <h3 className="text-xl font-bold text-white">Latest from @guhan_is_online</h3>
                <div className="flex items-center gap-1 text-gray-400 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <span>{isPolling ? 'Auto-Update ON' : 'Auto-Update OFF'}</span>
                </button>
            ...
            <div className="mt-8 text-center space-y-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-gradient-to-r from-[#5eead4] to-cyan-400 hover:from-[#5eead4]/90 hover:to-cyan-400/90 text-black font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105"
              >
                Follow on Threads
              </a>

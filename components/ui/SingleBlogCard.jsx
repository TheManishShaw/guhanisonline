...
const SingleBlogCard = () => {
  return (
    <div class="relative hover:scale-105 duration-200 transition-all ease-in-out flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
